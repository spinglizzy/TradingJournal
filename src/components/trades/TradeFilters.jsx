    ...
    <div className="space-y-3">
      ...
      {open && (
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          <div>
            <label className="block text-xs text-gray-500 mb-1.5">SMT Divergence</label>
            <select value={filters.smt_divergence} onChange={e => set('smt_divergence', e.target.value)}
              className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-indigo-500">
              <option value="">All</option>
          ...
          <div>
            <label className="block text-xs text-gray-500 mb-1.5">Bias</label>
            <select value={filters.bias} onChange={e => set('bias', e.target.value)}
              className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-indigo-500">
              <option value="">All</option>
