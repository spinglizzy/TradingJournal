      ...
      <div className="relative flex min-h-screen items-center justify-center px-4 z-10">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="space-y-1">
            ...
            <p className="text-gray-400 text-sm">Start tracking your trades today</p>
          </div>
          ...
          <p className="text-center text-sm text-gray-500">
            ...
            <Link to="/login" className="text-[#9aea62] hover:text-[#b5f08a] transition-colors font-medium">
              Sign in
            </Link>
          </p>
        </div>
